...
public class QuestManager extends ScriptManager<Quest>
{
    ...
    public final boolean removeQuest(Quest q)
    {
	    ...
	    /** 
	     * @see com.l2jhellas.gameserver.scripting.ScriptManager#unload(com.l2jhellas.gameserver.scripting.ManagedScript) 
	     */ 
	    @Override 
	    ...
	    /** 
	     * @see com.l2jhellas.gameserver.scripting.ScriptManager#getScriptManagerName() 
	     */ 
	    @Override 
