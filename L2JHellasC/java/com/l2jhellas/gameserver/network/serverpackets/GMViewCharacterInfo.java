...
public class GMViewCharacterInfo extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		writeF(_activeChar.getTemplate().getCollisionRadius(_activeChar.getAppearance().getSex())); // scale
		writeF(_activeChar.getTemplate().getCollisionHeight(_activeChar.getAppearance().getSex())); // y offset ??!? fem dwarf 4033
