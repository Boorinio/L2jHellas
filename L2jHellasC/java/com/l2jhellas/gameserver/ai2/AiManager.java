 ...
 */
package com.l2jhellas.gameserver.ai2;
...
import com.l2jhellas.gameserver.ai2.AiInstance.QueueEventRunner;
		...
		try
		{
			...
			for(String file : directory.list())
			{
				if(file.endsWith(".class"))
				{
					try
					{
						Class<?> managerClass = Class.forName("com.l2jhellas.gameserver.ai.managers."+file.substring(0, file.length() - 6));
