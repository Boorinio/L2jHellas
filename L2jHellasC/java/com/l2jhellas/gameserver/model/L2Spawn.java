...
public class L2Spawn
{
	...
	public L2Spawn(L2NpcTemplate mobTemplate) throws SecurityException, ClassNotFoundException, NoSuchMethodException
	{
		...
		Class[] parameters = {int.class, Class.forName("com.l2jhellas.gameserver.templates.L2NpcTemplate")};
    ...
    */
    ...
    private L2NpcInstance intializeNpcInstance(L2NpcInstance mob)
    {
		...
		if (((mob instanceof L2MonsterInstance && !(mob instanceof L2RaidBossInstance)) || (mob instanceof L2RaidBossInstance && Config.CHAMPION_BOSS))
