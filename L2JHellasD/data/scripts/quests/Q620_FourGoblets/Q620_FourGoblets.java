...
public class Q620_FourGoblets extends Quest
{
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		{
			player.teleToLocation(169590, -90218, -2914, false); // Wigoth : Teleport back to Pilgrim's Temple
		}
		...
		else if (event.equalsIgnoreCase("tele_4sep"))
		{
			...
			{
				player.teleToLocation(178298, -84574, -7216, false);
				return null;
			}
		...
		else if (event.equalsIgnoreCase("tele_it"))
		{
			if (st.hasQuestItems(ANTIQUE_BROOCH))
			{
				player.teleToLocation(186942, -75602, -2834, false);
				return null;
			}
