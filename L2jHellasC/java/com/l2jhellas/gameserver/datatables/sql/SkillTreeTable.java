...
public class SkillTreeTable
{
	...
	public int getExpertiseLevel(int grade)
	{
		...
		_log.log(Level.WARNING, getClass().getName() + ": Expertise not found for grade " + grade);
		return 0;
	}
	...
	private SkillTreeTable()
	{
		...
		{
			_log.log(Level.WARNING, getClass().getName() + ": Error while creating skill tree (Class ID " + classId + "):" + e);
			if (Config.DEVELOPER)
			{
				e.printStackTrace();
			}
        ...
        {
			_log.log(Level.WARNING, getClass().getName() + ": Error while creating fishing skill table: " + e);
			if (Config.DEVELOPER)
			{
				e.printStackTrace();
			}
        ...
        {
			_log.log(Level.WARNING, getClass().getName() + ": Error while creating enchant skill table: " + e);
			if (Config.DEVELOPER)
			{
				e.printStackTrace();
			}
	...
	public L2SkillLearn[] getAvailableSkills(L2PcInstance cha, ClassId classId)
	{
		...
		if (skills == null)
		{
			...
			_log.log(Level.WARNING, getClass().getName() + ": Skilltree for class " + classId + " is not defined !");
	...
	public L2SkillLearn[] getAvailableSkills(L2PcInstance cha)
	{
	    ...
	    {
	        // the skilltree for this class is undefined, so we give an empty list
			_log.log(Level.WARNING, getClass().getName() + ": Skilltree for fishing is not defined !");
	        return new L2SkillLearn[0];
	    }
	...
	public L2EnchantSkillLearn[] getAvailableEnchantSkills(L2PcInstance cha)
    {
        ...
        {
            // the skilltree for this class is undefined, so we give an empty list
			_log.log(Level.WARNING, getClass().getName() + ": Skilltree for enchanting is not defined !");
    ...
    public L2PledgeSkillLearn[] getAvailablePledgeSkills(L2PcInstance cha)
    {
        ...
        if (skills == null)
        {
			...
			_log.log(Level.WARNING, getClass().getName() + ": No clan skills defined!");
