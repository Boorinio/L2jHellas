		...
		switch (state)
		{
			...
			case AUTHED:
				switch (opcode)
				{
					...
					case 0x48:
					break;
					case 0x54: // client send this packet when u are on boat and you re-login in game
					break;
					case 0x62:
			...
			case IN_GAME:
				switch (opcode)
				{
					...
					break;
					case 0xce: // MSN dialogs so that you don't see them in the console.
					break;
