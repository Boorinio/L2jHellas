...
CREATE TABLE `ctf` (
  `eventName` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '',
  `eventDesc` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '',
  `joiningLocation` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '',
