...
cat <<EOF>$CONF
#Configuration settings for L2JHellas-Datapack database installer script
...
echo ""
echo "(C) 2004-2012 L2JHellas DataPack Team"
echo "L2JHellas DataPack Database Installer comes with ABSOLUTELY NO WARRANTY"
