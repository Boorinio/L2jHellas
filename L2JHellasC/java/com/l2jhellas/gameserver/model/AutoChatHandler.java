...
public class AutoChatHandler implements SpawnListener
{
	 ...
	 * a previous one is not found. <BR>
	 * Returns the associated auto chat instance.
	 *
	 * @param L2Npc
	 *        npcInst
	 ...
	 * an NPC is spawned in the world. <BR>
	 * <BR>
	...
	public class AutoChatInstance
	{
		 ...
		 * and launches the scheduled chat task. <BR>
		 * Returns the object ID for the NPC instance, with which to refer
		 * to the created chat definition. <BR>
		 ...
		 * specified by the containing auto chat instance. <BR>
