...
INSERT INTO `buff_templates` VALUES ('58', 'SirensDance', '365', 'Sirens Dance', '1', '1', '1', '1', '80', '0', '0', '0', '0', '2');
...
ADD COLUMN `event_points`  decimal(11,0) NULL DEFAULT NULL AFTER `tries`;

-- rework of the custom TABLES
-- drop/INSTALL
SET FOREIGN_KEY_CHECKS=0;
--
