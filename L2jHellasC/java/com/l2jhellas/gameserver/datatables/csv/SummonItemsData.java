...
public class SummonItemsData
{
	...
	public SummonItemsData()
	{
		...
		{
			_log.log(Level.WARNING, getClass().getName() + ": Can not find 'data/summon_items.csv'" + e);
			if (Config.DEVELOPER)
			{
				e.printStackTrace();
			}
		...
		while (s.hasNextLine())
		{
			...
			{
				_log.log(Level.WARNING, getClass().getName() + ": Summon items data: Error in line " + lineCount + " -> incomplete/invalid data or wrong seperator!");
		...
		_log.log(Level.INFO, getClass().getSimpleName() + ": Loaded " + _summonitems.size() + " summon items.");
	}
