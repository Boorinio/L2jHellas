...
public class StaticObjects
{
	...
	public StaticObjects()
	{
		...
		parseData();
		_log.log(Level.INFO, getClass().getSimpleName() + ": Loaded " + _staticObjects.size() + " StaticObject Templates.");
	}
	...
	private void parseData()
	{
		...
		{
			_log.log(Level.WARNING, getClass().getName() + ": staticobjects.csv is missing in data folder");
		}
		catch (Exception e)
		{
			_log.log(Level.WARNING, getClass().getName() + ": error while creating StaticObjects table " + e);
			if (Config.DEVELOPER)
			{
				e.printStackTrace();
			}
