...
public class GeoEngine extends GeoData
{
	...
	// Public Methods
	/**
	 * @see com.l2jhellas.gameserver.GeoData#getType(int, int)
	 */
	@Override
	...
	/**
	 * @see com.l2jhellas.gameserver.GeoData#getHeight(int, int, int)
	 */
	@Override
	...
	/**
	 * @see com.l2jhellas.gameserver.GeoData#getSpawnHeight(int, int, int, int, int)
	 */
	@Override
	...
	/**
	 * @see com.l2jhellas.gameserver.GeoData#geoPosition(int, int)
	 */
	@Override
	...
	/**
	 * @see com.l2jhellas.gameserver.GeoData#canSeeTarget(com.l2jhellas.gameserver.model.L2Object, com.l2jhellas.gameserver.model.L2Object)
	 */
	@Override
	...
	/**
	 * @see com.l2jhellas.gameserver.GeoData#canSeeTargetDebug(com.l2jhellas.gameserver.model.actor.instance.L2PcInstance, com.l2jhellas.gameserver.model.L2Object)
	 */
	@Override
	...
	/**
	 * @see com.l2jhellas.gameserver.GeoData#getNSWE(int, int, int)
	 */
	@Override
	...
	/**
	 * @see com.l2jhellas.gameserver.GeoData#moveCheck(int, int, int, int, int, int)
	 */
	@Override
	...
	/**
	 * @see com.l2jhellas.gameserver.GeoData#addGeoDataBug(com.l2jhellas.gameserver.model.actor.instance.L2PcInstance, java.lang.String)
	 */
	@Override
