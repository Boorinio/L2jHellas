                ...
                case NEGATE:
                {
                    ...
                    else
                    {
                    	 ...
                    	 for (String stat : _negateStats)
                    	 {
	                    	 ...
	                    	 if (stat == "debuff") negateEffect(target,L2SkillType.DEBUFF,-1);
	                    	 if (stat == "weakness") negateEffect(target,L2SkillType.WEAKNESS,-1);
	                    	 if (stat == "stun") negateEffect(target,L2SkillType.STUN,-1);
	                    	 if (stat == "sleep") negateEffect(target,L2SkillType.SLEEP,-1);
	                    	 if (stat == "confusion") negateEffect(target,L2SkillType.CONFUSION,-1);
	                    	 if (stat == "mute") negateEffect(target,L2SkillType.MUTE,-1);
	                    	 if (stat == "fear") negateEffect(target,L2SkillType.FEAR,-1);
	                    	 if (stat == "poison") negateEffect(target,L2SkillType.POISON,skill.getNegateLvl());
	                    	 if (stat == "bleed") negateEffect(target,L2SkillType.BLEED,skill.getNegateLvl());
	                    	 if (stat == "paralyze") negateEffect(target,L2SkillType.PARALYZE,-1);
	                    	 if (stat == "root") negateEffect(target,L2SkillType.ROOT,-1);
	                    	 if (stat == "heal")
	                    	 {
