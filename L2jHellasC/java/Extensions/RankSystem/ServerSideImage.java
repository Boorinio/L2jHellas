...
public class ServerSideImage
{
	...
	/**
	 * Generate Html tag for image loaded from server side, image packet is
	 * sended before generate the Html tag.
	 * 
	 * @param player
	 *        - activeChar
	 * @param imgId
	 *        - any id
	 * @param src
	 *        - image name, example: image, no extention's, image should be in
	 *        game/data/images folder. <br>
