	...
	public void useSkill(L2Character activeChar, L2Skill skill, L2Object[] targets)
	{
        ...
        for(int index = 0;index < targets.length;index++)
        {
            ...
            if(skill.getSkillType() != L2SkillType.BUFF && skill.getSkillType() != L2SkillType.HOT
            		&& skill.getSkillType() != L2SkillType.CPHOT && skill.getSkillType() != L2SkillType.MPHOT
            		&& skill.getSkillType() != L2SkillType.UNDEAD_DEFENSE && skill.getSkillType() != L2SkillType.AGGDEBUFF
            		&& skill.getSkillType() != L2SkillType.CONT)
            {
