...
public class L2FestivalMonsterInstance extends L2MonsterInstance
{
	 ...
	 * <li>Set the name of the L2MonsterInstance</li> <li>Create a RandomAnimation Task that will be launched after the calculated delay if the server allow it</li><BR>
	 * <BR>
	 * 
	 * @param objectId
	...
	/**
	 * Actions: <li>Check if the killing object is a player, and then find the party they belong to.</li> <li>Add a blood offering item to the leader of the party.</li> <li>Update
	 * the party leader's inventory to show the new item addition.</li>
	 */
	@Override
