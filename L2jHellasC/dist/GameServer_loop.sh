...
#	java -Dfile.encoding=UTF-8 -Xmn128m -Xms512m -Xmx1024m -server -cp ./../libs/*:l2jhellas.jar com.l2jhellas.gameserver.GameServer > log/stdout.log 2>&1
	java -Dfile.encoding=UTF-8 -Xmx1024m -cp ./../libs/*:l2jhellas.jar com.l2jhellas.gameserver.GameServer > log/stdout.log 2>&1
	err=$?
