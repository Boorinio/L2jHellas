...
{
	private static final int[] NPC ={30026,30031,30037,30066,30070,30109,30115,30120,30154,30174,30175,30176,30187, 
	...
	private static final Map<String, String> LEADER_REQUIRED = new HashMap<String, String>();
	static
	{
