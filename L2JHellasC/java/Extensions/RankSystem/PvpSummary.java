...
public class PvpSummary
{
	 ...
	 * 
	 * @param values
	 *        - received from getPointsForKill().
	 * @return
	 */
	...
	/**
	 * Update current Rank for this character,<br>
	 * should be executed always when pvpExp is updated.
	 */
