...
import com.l2jhellas.gameserver.network.serverpackets.BuyListSeed;
...
import com.l2jhellas.gameserver.network.serverpackets.ExShowProcureCropDetail;
...
public class L2ManorManagerInstance extends L2MerchantInstance
{
	...
	private static void showBuyWindow(L2PcInstance player, String val)
	{
		double taxRate = 0;
