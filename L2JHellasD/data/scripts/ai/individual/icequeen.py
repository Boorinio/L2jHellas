...
class icequeen (JQuest) :
 ...
 def onAdvEvent (self,event,npc,player):
   if event == "prosnuca" :
     npc2 = self.addSpawn(ICE_QUEEEN,102727,-125655,-2846,0,False,0)
     self.startQuestTimer("vkrovatku",1800000,npc2,None)
     ...
     if player:
       ...
       return "<html><body><font color=LEVEL>Vremja Viwlo...</font></body></html>"
