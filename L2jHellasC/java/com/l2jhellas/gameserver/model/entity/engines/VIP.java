...
public class VIP
{
	...
	public static boolean _started = false, _joining = false, _sitForced = false;
	...
	public static void rewardNotVIP()
	{
		for (L2PcInstance player : _playersNotVIP)
		{
			if (player != null)
			{
				player.addItem("VIP Event: ", _notVipReward, _notVipRewardAmount, player, true);
	...
	public static void rewardVIP()
	{
		for (L2PcInstance player : _playersVIP)
		{
			...
			if (!player._isTheVIP)
			{
				player.addItem("VIP Event: ", _vipReward, _vipRewardAmount, player, true);
			...
			{
				player.addItem("VIP Event: ", _theVipReward, _theVipRewardAmount, player, true);
