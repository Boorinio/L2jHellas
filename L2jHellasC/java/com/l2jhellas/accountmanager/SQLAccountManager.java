 ...
 */
package com.l2jhellas.accountmanager;
...
public class SQLAccountManager
{
	...
	public static void main(String[] args) throws SQLException, IOException, NoSuchAlgorithmException
	{
		...
		if (_mode.equals("1"))
		{
			addOrUpdateAccount(_uname, _pass, _level); // Add or Update
		}

		if (_mode.equals("2"))
		{
			changeAccountLevel(_uname, _level); // Change Level
		}
	...
	private static void changeAccountLevel(String account, String level) throws SQLException
	{
		try (Connection con = L2DatabaseFactory.getInstance().getConnection())
		{
			...
			{
				System.out.println("Account " + account + " does not exist."); // Not Exist
			}
		}
	}
