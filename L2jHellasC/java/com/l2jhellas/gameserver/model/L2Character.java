...
public abstract class L2Character extends L2Object
{
	...
	*/
	...
	public boolean isAttackingDisabled() { return isImmobileUntilAttacked() || isStunned() || isSleeping() || _attackEndTime > GameTimeController.getGameTicks() || isFakeDeath() || isParalyzed(); }
	...
	public final void addEffect(L2Effect newEffect)
	{
		...
		synchronized(_effects)
		{
			...
			if (getBuffCount() > Config.BUFFS_MAX_AMOUNT && !doesStack(tempskill) && ((
                ...
                tempskill.getSkillType() == L2SkillType.DEBUFF ||
...
//	private int _floatingRunSpeed;
     ...
     *
     * @see com.l2jhellas.gameserver.model.L2Character.isInsideRadius(int x, int y, int z, int radius, boolean checkZ, boolean strictCheck)
     */
...
//
	...
	
	{
		...
		if (skill.getSkillType() == L2SkillType.PDAM || skill.getSkillType() == L2SkillType.BLOW 
				...
				if (target instanceof L2Character)
				{
					...
					if (activeChar != null)
					{
						...
						else
						{
							...
							else if (player instanceof L2Attackable && !(skill.getSkillType() == L2SkillType.SUMMON)&& !(skill.getSkillType() == L2SkillType.BEAST_FEED) && !(skill.getSkillType() == L2SkillType.UNLOCK)
