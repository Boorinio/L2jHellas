 	...
 	npc.addDamageHate(target, 0, 1); 
        ...
        if (_actor instanceof L2MinionInstance && ((L2MinionInstance)_actor).getLeader() != null)
        {
            ...
            // if (_actor.isRaid()) offset = 500; // for Raids - need correction 
         	if (_actor.isRaidMinion()) offset = 500;
            ...
            if (dist2 > range*range)
            {
                ...
                if (!_actor.isMuted() &&
                    ...
                    for (L2Skill sk : skills)
                    {
                        ...
                        if (((sk.getSkillType() == L2SkillType.BUFF || sk.getSkillType() == L2SkillType.HEAL) || (dist2 >= castRange * castRange / 9.0)
                            ...
                            && Rnd.nextInt(100) <= 5)
                        {
                            ...
                            if (sk.getSkillType() == L2SkillType.BUFF
                                || sk.getSkillType() == L2SkillType.HEAL)
                            {
