...
CREATE TABLE `custom_armor` (
  ...
  `bodypart` varchar(15) COLLATE utf8_bin NOT NULL DEFAULT '',
  `crystallizable` varchar(5) COLLATE utf8_bin NOT NULL DEFAULT '',
  `armor_type` varchar(5) COLLATE utf8_bin NOT NULL DEFAULT '',
  `weight` int(5) NOT NULL DEFAULT '0',
  `material` varchar(15) COLLATE utf8_bin NOT NULL DEFAULT '',
  `crystal_type` varchar(4) COLLATE utf8_bin NOT NULL DEFAULT '',
