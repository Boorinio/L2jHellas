...
public final class SystemMessageId
{
	...
	/**
	 * ID: 331<br>
	 * Message: You have ACQUIRED_S1_S2 $s1 SP.
	 */
	...
	/**
	 * ID: 362<br>
	 * Message: You have ACQUIRED_S1_S2 $s1 bonus experience from a successful over-hit.
	 */
	...
	/**
	 * ID: 1707<br>
	 * Message: You ACQUIRED_S1_S2 $s1 PC Bang Point.
	 */
	public static final SystemMessageId ACQUIRED_S1_PCPOINT;
	
	/**
	 * ID: 1708<br>
	 * Message: Double points! You ACQUIRED_S1_S2 $s1 PC Bang Point.
	 */
	...
	/**
	 * ID: 1774<br>
	 * Message: Your clan's newly ACQUIRED_S1_S2 contested clan hall has added $s1 points to your clan's reputation score.
	 */
