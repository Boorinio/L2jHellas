...
CREATE TABLE `auction` (
  ...
  `sellerName` varchar(50) COLLATE utf8_bin NOT NULL DEFAULT 'NPC',
  `sellerClanName` varchar(50) COLLATE utf8_bin NOT NULL DEFAULT '',
  `itemType` varchar(25) COLLATE utf8_bin NOT NULL DEFAULT '',
  `itemId` int(11) NOT NULL DEFAULT '0',
  `itemObjectId` int(11) NOT NULL DEFAULT '0',
  `itemName` varchar(40) COLLATE utf8_bin NOT NULL DEFAULT '',
...
(58, 0, 'NPC', 'NPC Clan', 'ClanHall', 58, 0, 'Eisen Hall', 1, 20000000, 0, 1164841200000),
(59, 0, 'NPC', 'NPC Clan', 'ClanHall', 59, 0, 'Heavy Metal Hall', 1, 20000000, 0, 1164841200000),
(60, 0, 'NPC', 'NPC Clan', 'ClanHall', 60, 0, 'Molten Ore Hall', 1, 20000000, 0, 1164841200000),
(61, 0, 'NPC', 'NPC Clan', 'ClanHall', 61, 0, 'Titan Hall', 1, 20000000, 0, 1164841200000);