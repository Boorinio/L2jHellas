...
CREATE TABLE `balance` (
  ...
  `patk` SMALLINT NOT NULL DEFAULT '0',
  `matk` SMALLINT NOT NULL DEFAULT '0',
  `pdef` SMALLINT NOT NULL DEFAULT '0',
  `mdef` SMALLINT NOT NULL DEFAULT '0',
  `acc` SMALLINT NOT NULL DEFAULT '0',
  `ev` SMALLINT NOT NULL DEFAULT '0',
  `patksp` SMALLINT NOT NULL DEFAULT '0',
  `matksp` SMALLINT NOT NULL DEFAULT '0',
  `cp` SMALLINT NOT NULL DEFAULT '0',
  `hp` SMALLINT NOT NULL DEFAULT '0',
  `mp` SMALLINT NOT NULL DEFAULT '0',
  `walk` SMALLINT NOT NULL DEFAULT '0',
  `critical` SMALLINT NOT NULL DEFAULT '0',
  `magiccritical` SMALLINT NOT NULL DEFAULT '0',
  `walkspeed` SMALLINT NOT NULL DEFAULT '0',
  `matkrange` SMALLINT NOT NULL DEFAULT '0',
  `mreuserate` SMALLINT NOT NULL DEFAULT '0',
  `preuserate` SMALLINT NOT NULL DEFAULT '0',
