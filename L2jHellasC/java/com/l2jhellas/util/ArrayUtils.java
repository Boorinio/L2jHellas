 ...
 * </p>
 * <p>
 * This class tries to handle {@code null} input gracefully. An exception will not be thrown for a {@code null} array input. However, an Object array that contains a {@code null}
...
public class ArrayUtils
{
	...
	/**
	 * <p>
	 * ArrayUtils instances should NOT be constructed in standard programming. Instead, the class should be used as <code>ArrayUtils.clone(new int[] {2})</code>.
	 * </p>
	 * <p>
	 ...
	 * </p>
	 * <p>
	 * Note, this method makes only sense to provide arguments of the same type so that the compiler can deduce the type of the array itself. While it is possible to select the
	 * type explicitly like in <code>Number[] array = ArrayUtils.&lt;Number&gt;toArray(Integer.valueOf(42), Double.valueOf(Math.PI))</code>, there is no real advantage when
	...
	/**
	 * <p>
	 * Finds the index of the given value within a given tolerance in the array. This method will return the index of the first value which falls between the region defined by
	 * valueToFind - tolerance and valueToFind + tolerance.
	 * </p>
	 * <p>
	 * This method returns {@link #INDEX_NOT_FOUND} ({@code -1}) for a {@code null} input array.
	 * </p>
	...
	/**
	 * <p>
	 * Finds the index of the given value in the array starting at the given index. This method will return the index of the first value which falls between the region defined by
	 * valueToFind - tolerance and valueToFind + tolerance.
	 * </p>
	 * <p>
	 * This method returns {@link #INDEX_NOT_FOUND} ({@code -1}) for a {@code null} input array.
	...
	/**
	 * <p>
	 * Finds the last index of the given value within a given tolerance in the array. This method will return the index of the last value which falls between the region defined by
	 * valueToFind - tolerance and valueToFind + tolerance.
	 * </p>
	 * <p>
	 * This method returns {@link #INDEX_NOT_FOUND} ({@code -1}) for a {@code null} input array.
	...
	/**
	 * <p>
	 * Finds the last index of the given value in the array starting at the given index. This method will return the index of the last value which falls between the region defined
	 * by valueToFind - tolerance and valueToFind + tolerance.
	 * </p>
	 * <p>
	 * This method returns {@link #INDEX_NOT_FOUND} ({@code -1}) for a {@code null} input array.
	 * </p>
	...
	/**
	 * <p>
	 * Checks if a value falling within the given tolerance is in the given array. If the array contains a value within the inclusive range defined by (value - tolerance) to (value
	 * + tolerance).
	 * </p>
	 * <p>
	 * The method returns {@code false} if a {@code null} array is passed in.
	 ...
	 * </p>
	 * <p>
	 * The new array contains the same elements of the input array plus the given element in the last position. The component type of the new array is the same as that of the input
	 * array.
	 * </p>
	 * <p>
	 * If the input array is {@code null}, a new one element array is returned whose component type is the same as the element, unless the element itself is null, in which case the
	...
	/**
	 * <p>
	 * Inserts the specified element at the specified position in the array. Shifts the element currently at that position (if any) and any subsequent elements to the right (adds
	 * one to their indices).
	 * </p>
	 * <p>
	 * This method returns a new array with the same elements of the input array plus the given element on the specified position. The component type of the returned array is
	 ...
	 * </p>
	 * <p>
	 * This method returns a new array with the same elements of the input array except the element on the specified position. The component type of the returned array is always
	 * the same as that of the input array.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Removes the first occurrence of the specified element from the specified array. All subsequent elements are shifted to the left (subtracts one from their indices). If the
	 * array doesn't contains such an element, no elements are removed from the array.
	 * </p>
	 * <p>
	 * This method returns a new array with the same elements of the input array except the first occurrence of the specified element. The component type of the returned array is
	 * always the same as that of the input array.
	 * </p>
	 * 
	 * <pre>
	 ...
	 * </p>
	 * <p>
	 * This method returns a new array with the same elements of the input array except those at the specified positions. The component type of the returned array is always the
	...
	/**
	 * <p>
	 * Removes occurrences of specified elements, in specified quantities, from the specified array. All subsequent elements are shifted left. For any element-to-be-removed
	 * specified in greater quantities than contained in the original array, no change occurs beyond the removal of the existing matching items.
	 * </p>
	 * <p>
	 * This method returns a new array with the same elements of the input array except for the earliest-encountered occurrences of the specified elements. The component type of
