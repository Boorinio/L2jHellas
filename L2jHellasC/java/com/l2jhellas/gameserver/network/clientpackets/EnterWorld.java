...
import com.l2jhellas.gameserver.network.serverpackets.ExBrPremiumState;
...
import com.l2jhellas.gameserver.network.serverpackets.PremiumState;
...
public class EnterWorld extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (Config.WELCOME_TEXT_FOR_DONATOR_ENABLED)
		{
			if (activeChar.isDonator())
			{
